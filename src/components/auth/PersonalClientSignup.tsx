...
export default function PersonalClientSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/get-user-by-email`, {
        method: 'POST',
        headers: {
      ...
      // Set one year from now as trial expiration
      const oneYearFromNow = new Date();
      oneYearFromNow.setFullYear(oneYearFromNow.getFullYear() + 1);

      // Create profile with personal client settings and Plus subscription tier
      const { error: profileError } = await supabase
        ...
        .insert([{
          ...
          trial_expiration: oneYearFromNow.toISOString()
        }]);
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <img
            ...
            alt="Siena"
            className="mx-auto h-24 w-auto sm:h-32" // bigger logo
          />
          <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900">
            Personal Client Registration
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Create your account with 1 year of complimentary Plus access
          </p>
        </div>
          ...
          <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full rounded-md border-0 py-1.5 pl-10 text-gray-900 
                               ...
                               focus:ring-2 focus:ring-inset focus:ring-brand-green sm:text-sm sm:leading-6"
            ...
            <div className="flex items-start">
              ...
              <label htmlFor="smsOptIn" className="ml-2 block text-sm text-gray-600">
                I agree to receive account-related text messages from Siena (e.g., signup confirmations, login links, and reminders). 
